...
function CalendarRoot({
  ...
  rootRef,
  ...props
}: { rootRef?: Ref<HTMLDivElement> } & HTMLAttributes<HTMLDivElement>) {
...
function CalendarChevron({
  ...
  orientation,
  ...props
}: { className?: string; orientation?: 'left' | 'right' | 'up' | 'down' } & Record<
  string,
  unknown
>) {
  if (orientation === 'left') {
...
function CalendarWeekNumber({
  week: _week,
  ...props
}: { week: CalendarWeek } & ThHTMLAttributes<HTMLTableCellElement>) {
  return (
    <td {...props}>
