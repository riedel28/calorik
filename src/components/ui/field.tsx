  ...
  variants: {
    orientation: {
      horizontal: [
        ...
        'has-[button[role=radio]]:group-hover/field-label:bg-accent',
      ],
      responsive: [
  ...
  return (
    <Label
      className={cn(
        ...
        'has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border *:data-[slot=field]:px-3 *:data-[slot=field]:py-2.5',
        'has-data-checked:border-primary has-data-checked:bg-primary/5 dark:has-data-checked:bg-primary/10',
        'has-[[role=radio]]:transition-colors',
        'overflow-hidden',
        className,
      )}
